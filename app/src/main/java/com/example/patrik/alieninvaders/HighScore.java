...
public class HighScore extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
        System.out.println(sharedPreferences.getInt("score1",0));
        System.out.println(sharedPreferences.getInt("score2",0));
        System.out.println(sharedPreferences.getInt("score3",0));
        System.out.println(sharedPreferences.getInt("score4",0));
        */
    }
}